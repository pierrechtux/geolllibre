...
Pour rabouter, un coup de rebol:{{{
t: read/lines %kk
out: copy {}
loop 3 [append out rejoin [first t newline]
t: next t]

foreach l t [
	either (not tail? t) [
		append out rejoin ["'" l "'," newline]
	] [
		append out rejoin ["'" l "');" newline]
	]
]
...
qu'on joue finalement:
  # pierre@autan: ~        < 2013_09_12__21_26_44 >
psql -h autan -d bdexplo -f kkk
...
COMMIT
 ...
 public | ancient_workings                   | table | pierre   | 56 kB      | Ancient workings, either historic or recent{{{

                                                                    Table "public.ancient_workings"
   Column    |          Type          |                             Modifiers                              | Storage  |                   Description                   
-------------+------------------------+--------------------------------------------------------------------+----------+-------------------------------------------------
 ...
 datasource  | integer                |                                                                    | plain    | Datasource identifier, refers to lex_datasource
Indexes:
    "ancient_workings_pkey" PRIMARY KEY, btree (gid)
    "ancient_workings_the_geom_gist" gist (the_geom)
Check constraints:
...
Has OIDs: no
 ...
 public | baselines                          | table | pierre   | 16 kB      | Baselines, for each prospect, defined as a theoritical line between two points{{{                                                                               Table "public.baselines"
       Column        |            Type             |                          Modifiers                          | Storage  |                       Description                        
---------------------+-----------------------------+-------------------------------------------------------------+----------+----------------------------------------------------------
 opid                | integer                     |                                                             | plain    | Operation identifier
 id                  | integer                     |                                                             | plain    | Baseline identifier
 location            | character varying           |                                                             | extended | 
 x1                  | numeric(10,3)               |                                                             | main     | Baseline starting point x coordinate
 y1                  | numeric(10,3)               |                                                             | main     | Baseline starting point y coordinate
 z1                  | numeric(10,3)               |                                                             | main     | Baseline starting point z coordinate
 x2                  | numeric(10,3)               |                                                             | main     | Baseline ending point x coordinate
 y2                  | numeric(10,3)               |                                                             | main     | Baseline ending point y coordinate
 z2                  | numeric(10,3)               |                                                             | main     | Baseline ending point z coordinate
 numauto             | integer                     | not null default nextval('baselines_numauto_seq'::regclass) | plain    | Automatic integer primary key
 db_update_timestamp | timestamp without time zone | default now()                                               | plain    | Current date and time stamp when data is loaded in table
 username            | character varying           | default "current_user"()                                    | extended | User (role) which created data record
 datasource          | integer                     |                                                             | plain    | Datasource identifier, refers to lex_datasource
Indexes:
    "baselines_pkey" PRIMARY KEY, btree (numauto)
Has OIDs: no


}}}

 public | lab_ana_batches_expedition         | table | pierre   | 80 kB      | Batches of samples sent for analysis{{{                                                                               Table "public.lab_ana_batches_expedition"
       Column        |            Type             |                                  Modifiers                                   | Storage  |                       Description                        
---------------------+-----------------------------+------------------------------------------------------------------------------+----------+----------------------------------------------------------
 opid                | integer                     |                                                                              | plain    | Operation identifier
 batch_id            | integer                     |                                                                              | plain    | 
 labname             | character varying(50)       |                                                                              | extended | 
 expedition_id       | character varying(20)       |                                                                              | extended | 
 order_id            | character varying(20)       |                                                                              | extended | 
 description         | character varying           |                                                                              | extended | 
 preparation         | character varying(10)       |                                                                              | extended | 
 process_labo        | character varying(10)       |                                                                              | extended | 
 scheme              | character varying           |                                                                              | extended | 
 shipment_date       | date                        |                                                                              | plain    | 
 sent_to_lab         | boolean                     |                                                                              | plain    | 
 reception_date      | date                        |                                                                              | plain    | 
 results_received    | boolean                     |                                                                              | plain    | 
 lab_batches         | character varying           |                                                                              | extended | 
 comments            | character varying           |                                                                              | extended | 
 datasource          | character varying           |                                                                              | extended | Datasource identifier, refers to lex_datasource
 samples_amount      | integer                     |                                                                              | plain    | 
 sample_id_first     | character varying           |                                                                              | extended | 
 sample_id_last      | character varying           |                                                                              | extended | 
 db_update_timestamp | timestamp without time zone | default now()                                                                | plain    | Current date and time stamp when data is loaded in table
 username            | character varying           | default "current_user"()                                                     | extended | User (role) which created data record
 numauto             | integer                     | not null default nextval('lab_ana_batches_expedition_numauto_seq'::regclass) | plain    | Automatic integer primary key
Indexes:
    "lab_ana_batches_expedition_pkey" PRIMARY KEY, btree (numauto)
Has OIDs: no
}}}
 public | lab_ana_batches_reception          | table | pierre   | 264 kB     | {{{                                                                                Table "public.lab_ana_batches_reception"
       Column        |            Type             |                                  Modifiers                                  | Storage  |                        Description                         
---------------------+-----------------------------+-----------------------------------------------------------------------------+----------+------------------------------------------------------------
 opid                | integer                     |                                                                             | plain    | Operation identifier
 jobno               | character varying           |                                                                             | extended | 
 generic_txt         | character varying           |                                                                             | extended | 
 numauto             | integer                     | not null default nextval('lab_ana_batches_reception_numauto_seq'::regclass) | plain    | Automatic integer primary key
 datasource          | integer                     |                                                                             | plain    | Datasource identifier, refers to lex_datasource
 labname             | character varying           |                                                                             | extended | As in files received from laboratory: full laboratory name
 client              | character varying           |                                                                             | extended | As in files received from laboratory: client name
 validated           | date                        |                                                                             | plain    | As in files received from laboratory: validation date
 job_number          | character varying           |                                                                             | extended | As in files received from laboratory: job number
 number_of_samples   | integer                     |                                                                             | plain    | As in files received from laboratory: number of samples
 project             | character varying           |                                                                             | extended | As in files received from laboratory: project name
 shipment_id         | character varying           |                                                                             | extended | As in files received from laboratory: shipment id
 p_o_number          | character varying           |                                                                             | extended | As in files received from laboratory: P.O. number
 received            | date                        |                                                                             | plain    | As in files received from laboratory: reception date
 db_update_timestamp | timestamp without time zone | default now()                                                               | plain    | Current date and time stamp when data is loaded in table
 username            | character varying           | default "current_user"()                                                    | extended | User (role) which created data record
Indexes:
    "lab_ana_batches_reception_pkey" PRIMARY KEY, btree (numauto)
Has OIDs: no
}}}
 public | lab_ana_columns_definition         | table | pierre   | 24 kB      | {{{                                                                               Table "public.lab_ana_columns_definition"
       Column        |            Type             |                                  Modifiers                                   | Storage  |                       Description                        
---------------------+-----------------------------+------------------------------------------------------------------------------+----------+----------------------------------------------------------
 analyte             | character varying(20)       |                                                                              | extended | 
 unit                | character varying           |                                                                              | extended | 
 scheme              | character varying(20)       |                                                                              | extended | 
 colid               | text                        |                                                                              | extended | 
 opid                | integer                     |                                                                              | plain    | Operation identifier
 db_update_timestamp | timestamp without time zone | default now()                                                                | plain    | Current date and time stamp when data is loaded in table
 username            | character varying           | default "current_user"()                                                     | extended | User (role) which created data record
 numauto             | integer                     | not null default nextval('lab_ana_columns_definition_numauto_seq'::regclass) | plain    | Automatic integer primary key
Indexes:
    "lab_ana_columns_definition_pkey" PRIMARY KEY, btree (numauto)
Has OIDs: no
}}}
 public | lab_ana_results                    | table | pierre   | 277 MB     | Laboratory results table, after laboratory instructions, related to LIMS system{{{                                                                               Table "public.lab_ana_qaqc_results"
       Column        |            Type             |                               Modifiers                                | Storage  |                       Description                        
---------------------+-----------------------------+------------------------------------------------------------------------+----------+----------------------------------------------------------
 opid                | integer                     |                                                                        | plain    | Operation identifier
 jobno               | character varying           |                                                                        | extended | 
 generic_txt_col1    | character varying           |                                                                        | extended | 
 generic_txt_col2    | character varying           |                                                                        | extended | 
 generic_txt_col3    | character varying           |                                                                        | extended | 
 generic_txt_col4    | character varying           |                                                                        | extended | 
 generic_txt_col5    | character varying           |                                                                        | extended | 
 datasource          | integer                     |                                                                        | plain    | Datasource identifier, refers to lex_datasource
 numauto             | integer                     | not null default nextval('lab_ana_qaqc_results_numauto_seq'::regclass) | plain    | Automatic integer primary key
 db_update_timestamp | timestamp without time zone | default now()                                                          | plain    | Current date and time stamp when data is loaded in table
 username            | character varying           | default "current_user"()                                               | extended | User (role) which created data record
Indexes:
    "lab_ana_qaqc_results_pkey" PRIMARY KEY, btree (numauto)
Has OIDs: no
}}}
 public | lab_ana_qaqc_results               | table | pierre   | 136 kB     | {{{                                                                                                                 Table "public.lab_ana_results"
       Column        |            Type             |                             Modifiers                             | Storage  |                                                         Description                                                          
---------------------+-----------------------------+-------------------------------------------------------------------+----------+------------------------------------------------------------------------------------------------------------------------------
 labname             | character varying(10)       |                                                                   | extended | Analytical laboratory
 jobno               | character varying(20)       |                                                                   | extended | jcsa.pro_job,           --> Intertek JobNo (VarChar(20))
 orderno             | character varying(40)       |                                                                   | extended | pj.orderno,              --> Client Order No (VarChar(40))
 sample_id           | character varying(40)       |                                                                   | extended | Sample Identifier
 scheme              | character varying(20)       |                                                                   | extended | pjcsa.sch_code,          --> Scheme Code (Intertek Internal Code - which probably reported to Client as well) (VarChar(20))
 analyte             | character varying(20)       |                                                                   | extended | pjcsa.analytecode,       --> Analyte Code (Intertek Internal Code - which probably reported to Client as well) (VarChar(20))
 value               | character varying(20)       |                                                                   | extended | pjcsa.formattedvalue     --> Reported Value (VarChar(20))
 db_update_timestamp | timestamp without time zone | default now()                                                     | plain    | Current date and time stamp when data is loaded in table
 value_num           | numeric                     |                                                                   | main     | Reported value, converted to numeric. IS becomes -999, LNR -9999, < -, > nothing
 opid                | integer                     |                                                                   | plain    | Operation identifier
 batch_id            | integer                     |                                                                   | plain    | 
 sampletype          | character varying           |                                                                   | extended | 
 unit                | character varying           |                                                                   | extended | 
 datasource          | integer                     |                                                                   | plain    | Datasource identifier, refers to lex_datasource
 numauto             | integer                     | not null default nextval('lab_ana_results_numauto_seq'::regclass) | plain    | Automatic integer primary key
 sample_id_lab       | character varying           |                                                                   | extended | pjc.sampleident,         --> Client SampleID (VarChar(40)) => sometimes different from REAL sample_id
 valid               | boolean                     | default true                                                      | plain    | Analysis is considered as valid or ignored (if QAQC failed, for instance)
 detlim              | numeric                     |                                                                   | main     | Lower detection limit
 uplim               | numeric                     |                                                                   | main     | Upper limit
Triggers:
    lab_ana_results_insert AFTER INSERT ON public.lab_ana_results FOR EACH STATEMENT EXECUTE PROCEDURE lab_ana_results_sample_id_default_value_num()
Has OIDs: no
}}}

 public | qc_sampling                        | table | pierre   | 760 kB     | Quality control samples: duplicates, blanks, standards {{{                                                                               Table "public.qc_sampling"
       Column        |            Type             |                           Modifiers                           | Storage  |                       Description                        
---------------------+-----------------------------+---------------------------------------------------------------+----------+----------------------------------------------------------
 sample_id           | character varying(20)       |                                                               | extended | 
 qc_type             | character varying           |                                                               | extended | 
 comments            | character varying           |                                                               | extended | 
 opid                | integer                     |                                                               | plain    | Operation identifier
 batch_id            | integer                     |                                                               | plain    | 
 refers_to           | character varying           |                                                               | extended | 
 datasource          | integer                     |                                                               | plain    | Datasource identifier, refers to lex_datasource
 weight_kg           | numeric(6,2)                |                                                               | main     | 
 numauto             | integer                     | not null default nextval('qc_sampling_numauto_seq'::regclass) | plain    | Automatic integer primary key
 db_update_timestamp | timestamp without time zone | default now()                                                 | plain    | Current date and time stamp when data is loaded in table
 username            | character varying           | default "current_user"()                                      | extended | User (role) which created data record
Indexes:
    "qc_sampling_pkey" PRIMARY KEY, btree (numauto)
    "qc_sampling_sample_id" btree (sample_id)
Has OIDs: no
}}}
 public | qc_standards                       | table | pierre   | 16 kB      | Quality Control standard samples, most of them are CRM (Certified Reference Materials) {{{                                                                                  Table "public.qc_standards"
          Column           |            Type             |                           Modifiers                            | Storage  |                       Description                        
---------------------------+-----------------------------+----------------------------------------------------------------+----------+----------------------------------------------------------
 qc_id                     | character varying(20)       | not null                                                       | extended | sample identification
 labo                      | character varying(50)       |                                                                | extended | sample laboratory
 matrix                    | character varying(50)       |                                                                | extended | sample composition
 presentation              | character varying(50)       |                                                                | extended | sample presentation
 au_ppm                    | numeric(10,3)               |                                                                | main     | sample analysis value
 cu_ppm                    | numeric(10,3)               |                                                                | main     | sample analysis value
 zn_ppm                    | numeric(10,3)               |                                                                | main     | sample analysis value
 pb_ppm                    | numeric(10,3)               |                                                                | main     | sample analysis value
 ag_ppm                    | numeric(10,3)               |                                                                | main     | sample analysis value
 ni_ppm                    | numeric(10,3)               |                                                                | main     | sample analysis value
 au_ppm_95pc_conf_interval | numeric                     |                                                                | main     | 
 cu_ppm_95pc_conf_interval | numeric                     |                                                                | main     | 
 zn_ppm_95pc_conf_interval | numeric                     |                                                                | main     | 
 pb_ppm_95pc_conf_interval | numeric                     |                                                                | main     | 
 ag_ppm_95pc_conf_interval | numeric                     |                                                                | main     | 
 ni_ppm_95pc_conf_interval | numeric                     |                                                                | main     | 
 opid                      | integer                     |                                                                | plain    | Operation identifier
 datasource                | integer                     |                                                                | plain    | Datasource identifier, refers to lex_datasource
 db_update_timestamp       | timestamp without time zone | default now()                                                  | plain    | Current date and time stamp when data is loaded in table
 username                  | character varying           | default "current_user"()                                       | extended | User (role) which created data record
 numauto                   | integer                     | not null default nextval('qc_standards_numauto_seq'::regclass) | plain    | Automatic integer primary key
Indexes:
    "qc_standards_pkey" PRIMARY KEY, btree (numauto)
    "lex_qc_qc_id_key" UNIQUE CONSTRAINT, btree (qc_id)
Has OIDs: no
}}}

 public | lex_codes                          | table | pierre   | 48 kB      | {{{                                                                               Table "public.lex_codes"
       Column        |            Type             |                          Modifiers                          | Storage  |                       Description                        
---------------------+-----------------------------+-------------------------------------------------------------+----------+----------------------------------------------------------
 opid                | integer                     |                                                             | plain    | Operation identifier
 tablename           | text                        |                                                             | extended | 
 field               | text                        |                                                             | extended | 
 code                | character varying           |                                                             | extended | 
 description         | character varying           |                                                             | extended | 
 datasource          | integer                     |                                                             | plain    | Datasource identifier, refers to lex_datasource
 numauto             | integer                     | not null default nextval('lex_codes_numauto_seq'::regclass) | plain    | Automatic integer primary key
 comments            | character varying           |                                                             | extended | 
 db_update_timestamp | timestamp without time zone | default now()                                               | plain    | Current date and time stamp when data is loaded in table
 username            | character varying           | default "current_user"()                                    | extended | User (role) which created data record
Indexes:
    "lex_codes_pkey" PRIMARY KEY, btree (numauto)
Has OIDs: no
}}}
 public | lex_datasource                     | table | pierre   | 152 kB     | {{{                                                                                  Table "public.lex_datasource"
       Column        |            Type             |                               Modifiers                                | Storage  |                       Description                        
---------------------+-----------------------------+------------------------------------------------------------------------+----------+----------------------------------------------------------
 opid                | integer                     |                                                                        | plain    | Operation identifier
 filename            | character varying(500)      |                                                                        | extended | 
 comments            | character varying           |                                                                        | extended | 
 datasource_id       | integer                     | not null default nextval('lex_datasource_datasource_id_seq'::regclass) | plain    | 
 db_update_timestamp | timestamp without time zone | default now()                                                          | plain    | Current date and time stamp when data is loaded in table
 username            | character varying           | default "current_user"()                                               | extended | User (role) which created data record
 numauto             | integer                     | not null default nextval('lex_datasource_numauto_seq'::regclass)       | plain    | Automatic integer primary key
Indexes:
    "lex_datasource_pkey" PRIMARY KEY, btree (numauto)
Has OIDs: no
}}}
 public | lex_standard                       | table | pierre   | 8192 bytes | table contenant les valeurs des standards or et multi elements{{{                                                                               Table "public.lex_standard"
       Column        |            Type             |                           Modifiers                            | Storage  |                       Description                        
---------------------+-----------------------------+----------------------------------------------------------------+----------+----------------------------------------------------------
 std_id              | character varying           | not null                                                       | extended | 
 unit                | character(5)                | not null                                                       | extended | 
 element             | character(5)                | not null                                                       | extended | 
 value               | numeric                     | not null                                                       | main     | 
 std_dev             | numeric                     |                                                                | main     | 
 interval_conf       | numeric                     |                                                                | main     | 
 std_origin          | character(25)               |                                                                | extended | 
 type_analyse        | character(25)               | not null                                                       | extended | 
 numauto             | integer                     | not null default nextval('lex_standard_numauto_seq'::regclass) | plain    | Automatic integer primary key
 opid                | integer                     |                                                                | plain    | Operation identifier
 db_update_timestamp | timestamp without time zone | default now()                                                  | plain    | Current date and time stamp when data is loaded in table
 username            | character varying           | default "current_user"()                                       | extended | User (role) which created data record
 datasource          | integer                     |                                                                | plain    | Datasource identifier, refers to lex_datasource
Indexes:
    "lex_standard_pkey" PRIMARY KEY, btree (numauto)
Has OIDs: no

}}}

 public | licences                           | table | pierre   | 16 kB      | Licences, tenements{{{                                                                               Table "public.licences"
       Column        |            Type             |                         Modifiers                          | Storage  |                       Description                        
---------------------+-----------------------------+------------------------------------------------------------+----------+----------------------------------------------------------
 opid                | integer                     |                                                            | plain    | Operation identifier
 id                  | integer                     | not null default nextval('licences_id_seq'::regclass)      | plain    | 
 licence_name        | character varying(50)       |                                                            | extended | 
 operator            | character varying(20)       |                                                            | extended | 
 year                | integer                     |                                                            | plain    | 
 lat_min             | numeric(10,5)               | not null                                                   | main     | 
 lon_min             | numeric(10,5)               | not null                                                   | main     | 
 lat_max             | numeric(10,5)               | not null                                                   | main     | 
 lon_max             | numeric(10,5)               | not null                                                   | main     | 
 comments            | character varying(500)      |                                                            | extended | 
 db_update_timestamp | timestamp without time zone | default now()                                              | plain    | Current date and time stamp when data is loaded in table
 username            | character varying           | default "current_user"()                                   | extended | User (role) which created data record
 numauto             | integer                     | not null default nextval('licences_numauto_seq'::regclass) | plain    | Automatic integer
 datasource          | integer                     |                                                            | plain    | Datasource identifier, refers to lex_datasource
Indexes:
    "licence_id" PRIMARY KEY, btree (id)
Has OIDs: no
}}}

 public | field_observations                 | table | pierre   | 720 kB     | {{{                                                                                Table "public.field_observations"
       Column        |            Type             |                               Modifiers                               | Storage  |                       Description                        
---------------------+-----------------------------+-----------------------------------------------------------------------+----------+----------------------------------------------------------
 opid                | integer                     |                                                                       | plain    | Operation identifier
 year                | integer                     |                                                                       | plain    | 
 obs_id              | character varying           |                                                                       | extended | 
 date                | date                        |                                                                       | plain    | 
 waypoint_name       | character varying           |                                                                       | extended | 
 x                   | numeric(20,10)              |                                                                       | main     | 
 y                   | numeric(20,10)              |                                                                       | main     | 
 z                   | numeric(20,2)               |                                                                       | main     | 
 description         | text                        |                                                                       | extended | 
 code_litho          | character varying(4)        |                                                                       | extended | 
 code_unit           | character varying(4)        |                                                                       | extended | 
 srid                | integer                     |                                                                       | plain    | 
 geologist           | character varying           |                                                                       | extended | 
 icon_descr          | character varying           |                                                                       | extended | 
 comments            | character varying           |                                                                       | extended | 
 sample_id           | character varying           |                                                                       | extended | 
 datasource          | integer                     |                                                                       | plain    | Datasource identifier, refers to lex_datasource
 numauto             | integer                     | not null default nextval('field_observations_numauto_seq2'::regclass) | plain    | Automatic integer primary key
 photos              | character varying           |                                                                       | extended | 
 audio               | character varying           |                                                                       | extended | 
 timestamp_epoch_ms  | bigint                      |                                                                       | plain    | 
 db_update_timestamp | timestamp without time zone | default now()                                                         | plain    | Current date and time stamp when data is loaded in table
 username            | character varying           | default "current_user"()                                              | extended | User (role) which created data record
Indexes:
    "field_observations_pkey1" PRIMARY KEY, btree (numauto)
Has OIDs: no
}}}
 public | field_observations_struct_measures | table | pierre   | 64 kB      | {{{                                                                               Table "public.field_observations_struct_measures"
       Column        |            Type             |                                      Modifiers                                       | Storage  |                       Description                        
---------------------+-----------------------------+--------------------------------------------------------------------------------------+----------+----------------------------------------------------------
 opid                | integer                     |                                                                                      | plain    | Operation identifier
 obs_id              | character varying           |                                                                                      | extended | 
 ...
 valid               | boolean                     |                                                                                      | plain    | 
 comments            | character varying           |                                                                                      | extended | 
 numauto             | integer                     | not null default nextval('field_observations_struct_measures_numauto_seq'::regclass) | plain    | Automatic integer primary key
 db_update_timestamp | timestamp without time zone | default now()                                                                        | plain    | Current date and time stamp when data is loaded in table
 username            | character varying           | default "current_user"()                                                             | extended | User (role) which created data record
 datasource          | integer                     |                                                                                      | plain    | Datasource identifier, refers to lex_datasource
Indexes:
    "field_observations_struct_measures_pkey" PRIMARY KEY, btree (numauto)
Has OIDs: no
}}}
 public | field_photos                       | table | pierre   | 8192 bytes | {{{                                                                               Table "public.field_photos"
       Column        |            Type             |                           Modifiers                            | Storage  |                       Description                        
---------------------+-----------------------------+----------------------------------------------------------------+----------+----------------------------------------------------------
 pho_id              | character varying           | not null                                                       | extended | 
 obs_id              | character varying           |                                                                | extended | 
 ...
 db_update_timestamp | timestamp without time zone | default now()                                                  | plain    | Current date and time stamp when data is loaded in table
 username            | character varying           | default "current_user"()                                       | extended | User (role) which created data record
 numauto             | integer                     | not null default nextval('field_photos_numauto_seq'::regclass) | plain    | Automatic integer
Indexes:
    "field_photos_id" PRIMARY KEY, btree (pho_id)
Has OIDs: no
}}}

 public | formations_group_lithos            | table | pierre   | 16 kB      | {{{                                                                               Table "public.formations_group_lithos"
       Column        |            Type             |                                 Modifiers                                 | Storage  |                       Description                        
---------------------+-----------------------------+---------------------------------------------------------------------------+----------+----------------------------------------------------------
 opid                | integer                     |                                                                           | plain    | Operation identifier
 formation_name      | character varying(25)       |                                                                           | extended | 
 code_litho          | character varying(4)        |                                                                           | extended | 
 db_update_timestamp | timestamp without time zone | default now()                                                             | plain    | Current date and time stamp when data is loaded in table
 username            | character varying           | default "current_user"()                                                  | extended | User (role) which created data record
 numauto             | integer                     | not null default nextval('formations_group_lithos_numauto_seq'::regclass) | plain    | Automatic integer primary key
Indexes:
    "formations_group_lithos_pkey" PRIMARY KEY, btree (numauto)
Has OIDs: no
}}}

 public | geoch_sampling                     | table | pierre   | 1976 kB    | Geochemistry samples, from soil or stream sediments, location and description{{{                                                                                 Table "public.geoch_sampling"
       Column        |            Type             |                              Modifiers                               | Storage  |                       Description                        
---------------------+-----------------------------+----------------------------------------------------------------------+----------+----------------------------------------------------------
 id                  | character varying(20)       |                                                                      | extended | Identification
 lab_id              | character varying(50)       |                                                                      | extended | Analysis laboratory
 labo_ref            | character varying(20)       |                                                                      | extended | Analysis laboratory report reference
 amc_ref             | character varying(20)       |                                                                      | extended | AMC analysis report reference
 recep_date          | date                        |                                                                      | plain    | Report reception date by AMC
 type                | character varying(20)       |                                                                      | extended | Analysis type
 sampl_index         | character varying           | not null default nextval('geoch_sampling_sampl_index_seq'::regclass) | extended | Auto increment integer
 x                   | numeric(15,4)               |                                                                      | main     | X coordinate, projected in UTM (m)
 y                   | numeric(15,4)               |                                                                      | main     | Y coordinate, projected in UTM (m)
 z                   | numeric(10,4)               |                                                                      | main     | Z coordinate, projected in UTM (m)
 soil_color          | character varying(50)       |                                                                      | extended | Soil color
 type_sort           | character varying(20)       |                                                                      | extended | Sort of type
 depth_cm            | numeric(10,2)               |                                                                      | main     | Sample depth
 reg_type            | character varying(20)       |                                                                      | extended | Type of region
 geomorphology       | character varying(20)       |                                                                      | extended | Some region description
 rock_type           | character varying(50)       |                                                                      | extended | Lithology
 comment             | character varying(200)      |                                                                      | extended | Some comments
 utm_zone            | character varying(3)        |                                                                      | extended | UTM area
 geologist           | character varying(20)       |                                                                      | extended | geologist
 float_sampl         | character varying(20)       |                                                                      | extended | sample designation (?)
 host_rock           | character varying(200)      |                                                                      | extended | host rock
 prospect            | character varying(20)       |                                                                      | extended | 
 spacing             | character varying(20)       |                                                                      | extended | 
 horizon             | character varying(20)       |                                                                      | extended | 
 datasource          | integer                     |                                                                      | plain    | Datasource identifier, refers to lex_datasource
 date                | date                        |                                                                      | plain    | type of survey (ex : HHGPS)
 survey_type         | character varying(50)       |                                                                      | extended | 
 opid                | integer                     |                                                                      | plain    | Operation identifier
 grid_line           | character varying           |                                                                      | extended | 
 grid_station        | character varying           |                                                                      | extended | 
 alteration          | character varying           |                                                                      | extended | 
 occ_soil            | character varying           |                                                                      | extended | 
 slope               | character varying           |                                                                      | extended | 
 slope_dir           | character varying           |                                                                      | extended | 
 soil_description    | character varying           |                                                                      | extended | 
 db_update_timestamp | timestamp without time zone | default now()                                                        | plain    | Current date and time stamp when data is loaded in table
 username            | character varying           | default "current_user"()                                             | extended | User (role) which created data record
 numauto             | integer                     | not null default nextval('geoch_sampling_numauto_seq'::regclass)     | plain    | Automatic integer
Indexes:
    "geoch_sampling_pkey" PRIMARY KEY, btree (sampl_index)
    "sampl_index_geoch_sampling" btree (sampl_index)
Child tables: public.geoch_sampling_grades
Has OIDs: no
}}}
 public | geoch_ana                          | table | pierre   | 13 MB      | Assay results from geochemistry samples{{{                                                                                Table "public.geoch_ana"
       Column        |            Type             |                          Modifiers                          | Storage  |                        Description                        
---------------------+-----------------------------+-------------------------------------------------------------+----------+-----------------------------------------------------------
 sampl_index         | integer                     |                                                             | plain    | Sample identification related to the geoch_sampling table
 ana_type            | character varying(20)       |                                                             | extended | Analysis type 
 unit                | character varying(10)       |                                                             | extended | Unit of the analysis 
 det_lim             | numeric(6,4)                |                                                             | main     | Analysis detection limit
 scheme              | character varying(20)       |                                                             | extended | Analysis method
 comment             | character varying(20)       |                                                             | extended | Some comments
 value               | numeric(10,3)               |                                                             | main     | Analysis value
 numauto             | integer                     | not null default nextval('geoch_ana_numauto_seq'::regclass) | plain    | Automatic integer primary key
 opid                | integer                     |                                                             | plain    | Operation identifier
 db_update_timestamp | timestamp without time zone | default now()                                               | plain    | Current date and time stamp when data is loaded in table
 username            | character varying           | default "current_user"()                                    | extended | User (role) which created data record
 datasource          | integer                     |                                                             | plain    | Datasource identifier, refers to lex_datasource
Indexes:
    "geoch_ana_pkey" PRIMARY KEY, btree (numauto)
    "sampl_index_geoch_ana" btree (sampl_index)
Has OIDs: no
}}}
 public | geoch_sampling_grades              | table | pierre   | 4424 kB    | {{{                                                                           Table "public.geoch_sampling_grades"
       Column        |            Type             |                                Modifiers                                | Storage  |                   Description                   
---------------------+-----------------------------+-------------------------------------------------------------------------+----------+-------------------------------------------------
 id                  | character varying(20)       |                                                                         | extended | 
 lab_id              | character varying(50)       |                                                                         | extended | 
 labo_ref            | character varying(20)       |                                                                         | extended | 
 amc_ref             | character varying(20)       |                                                                         | extended | 
 recep_date          | date                        |                                                                         | plain    | 
 type                | character varying(20)       |                                                                         | extended | 
 sampl_index         | character varying           | not null default nextval('geoch_sampling_sampl_index_seq'::regclass)    | extended | 
 x                   | numeric(15,4)               |                                                                         | main     | 
 y                   | numeric(15,4)               |                                                                         | main     | 
 z                   | numeric(10,4)               |                                                                         | main     | 
 soil_color          | character varying(50)       |                                                                         | extended | 
 type_sort           | character varying(20)       |                                                                         | extended | 
 depth_cm            | numeric(10,2)               |                                                                         | main     | 
 reg_type            | character varying(20)       |                                                                         | extended | 
 geomorphology       | character varying(20)       |                                                                         | extended | 
 rock_type           | character varying(50)       |                                                                         | extended | 
 comment             | character varying(200)      |                                                                         | extended | 
 utm_zone            | character varying(3)        |                                                                         | extended | 
 geologist           | character varying(20)       |                                                                         | extended | 
 float_sampl         | character varying(20)       |                                                                         | extended | 
 host_rock           | character varying(200)      |                                                                         | extended | 
 prospect            | character varying(20)       |                                                                         | extended | 
 spacing             | character varying(20)       |                                                                         | extended | 
 horizon             | character varying(20)       |                                                                         | extended | 
 datasource          | integer                     |                                                                         | plain    | Datasource identifier, refers to lex_datasource
 ...
 soil_description    | character varying           |                                                                         | extended | 
 au_ppb              | numeric                     |                                                                         | main     | 
 numauto             | integer                     | not null default nextval('geoch_sampling_grades_numauto_seq'::regclass) | plain    | Automatic integer primary key
 db_update_timestamp | timestamp without time zone | default now()                                                           | plain    | 
 username            | character varying           | default "current_user"()                                                | extended | 
Indexes:
    "geoch_sampling_grades_pkey" PRIMARY KEY, btree (numauto)
Inherits: public.geoch_sampling
Has OIDs: no
}}}
 public | surface_samples_grades             | table | pierre   | 5496 kB    | {{{                                                                               Table "public.surface_samples_grades"
       Column        |            Type             |                                Modifiers                                 | Storage  |                       Description                        
---------------------+-----------------------------+--------------------------------------------------------------------------+----------+----------------------------------------------------------
 opid                | integer                     |                                                                          | plain    | Operation identifier
 sample_id           | character varying           |                                                                          | extended | 
 ...
 srid                | integer                     |                                                                          | plain    | 
 description         | character varying           |                                                                          | extended | 
 sample_type         | character varying           |                                                                          | extended | 
 outcrop_id          | character varying           |                                                                          | extended | 
 trend               | character varying           |                                                                          | extended | 
 dip                 | character varying           |                                                                          | extended | 
 length_m            | character varying           |                                                                          | extended | 
 width_m             | character varying           |                                                                          | extended | 
 au1_ppm             | double precision            |                                                                          | plain    | 
 au2_ppm             | double precision            |                                                                          | plain    | 
 ag1_                | double precision            |                                                                          | plain    | 
 ag2_                | double precision            |                                                                          | plain    | 
 cu1_                | double precision            |                                                                          | plain    | 
 cu2_                | double precision            |                                                                          | plain    | 
 as_                 | double precision            |                                                                          | plain    | 
 pb_                 | double precision            |                                                                          | plain    | 
 zn_                 | double precision            |                                                                          | plain    | 
 k2o_                | double precision            |                                                                          | plain    | 
 ba_                 | double precision            |                                                                          | plain    | 
 sio2_               | double precision            |                                                                          | plain    | 
 al2x_               | double precision            |                                                                          | plain    | 
 fe2x_               | double precision            |                                                                          | plain    | 
 mno_                | double precision            |                                                                          | plain    | 
 tio2_               | double precision            |                                                                          | plain    | 
 p2o5_               | double precision            |                                                                          | plain    | 
 cao_                | double precision            |                                                                          | plain    | 
 mgo_                | double precision            |                                                                          | plain    | 
 mo_                 | double precision            |                                                                          | plain    | 
 sn_                 | double precision            |                                                                          | plain    | 
 sb_                 | double precision            |                                                                          | plain    | 
 w_                  | double precision            |                                                                          | plain    | 
 bi_                 | double precision            |                                                                          | plain    | 
 zr_                 | double precision            |                                                                          | plain    | 
 li_                 | double precision            |                                                                          | plain    | 
 b_                  | double precision            |                                                                          | plain    | 
 v_                  | double precision            |                                                                          | plain    | 
 cr_                 | double precision            |                                                                          | plain    | 
 ni_                 | double precision            |                                                                          | plain    | 
 co_                 | double precision            |                                                                          | plain    | 
 sr_                 | double precision            |                                                                          | plain    | 
 y_                  | double precision            |                                                                          | plain    | 
 la_                 | double precision            |                                                                          | plain    | 
 ce_                 | double precision            |                                                                          | plain    | 
 nb_                 | double precision            |                                                                          | plain    | 
 be_                 | double precision            |                                                                          | plain    | 
 cd_                 | double precision            |                                                                          | plain    | 
 spp2                | double precision            |                                                                          | plain    | 
 datasource_id       | integer                     |                                                                          | plain    | 
 numauto             | integer                     | not null default nextval('surface_samples_grades_numauto_seq'::regclass) | plain    | Automatic integer primary key
 db_update_timestamp | timestamp without time zone | default now()                                                            | plain    | Current date and time stamp when data is loaded in table
 username            | character varying           | default "current_user"()                                                 | extended | User (role) which created data record
 datasource          | integer                     |                                                                          | plain    | Datasource identifier, refers to lex_datasource
Indexes:
    "numauto_pkey" PRIMARY KEY, btree (numauto)
Has OIDs: no
}}}

 public | gpy_mag_ground                     | table | pierre   | 760 kB     | {{{                                                                                 Table "public.gpy_mag_ground"
         Column         |            Type             |                            Modifiers                             | Storage  |                       Description                        
------------------------+-----------------------------+------------------------------------------------------------------+----------+----------------------------------------------------------
 opid                   | integer                     |                                                                  | plain    | Operation identifier
 srid                   | integer                     |                                                                  | plain    | 
 ...
 y                      | numeric(10,2)               |                                                                  | main     | 
 z                      | numeric(10,2)               |                                                                  | main     | 
 x_local                | numeric(10,2)               |                                                                  | main     | 
 y_local                | numeric(10,2)               |                                                                  | main     | 
 mag_nanotesla          | double precision            |                                                                  | plain    | 
 val_corr_mag_nanotesla | double precision            |                                                                  | plain    | 
 db_update_timestamp    | timestamp without time zone | default now()                                                    | plain    | Current date and time stamp when data is loaded in table
 username               | character varying           | default "current_user"()                                         | extended | User (role) which created data record
 numauto                | integer                     | not null default nextval('gpy_mag_ground_numauto_seq'::regclass) | plain    | Automatic integer primary key
 datasource             | integer                     |                                                                  | plain    | Datasource identifier, refers to lex_datasource
Indexes:
    "gpy_mag_ground_pkey" PRIMARY KEY, btree (numauto)
Has OIDs: no
}}}
 public | grade_ctrl                         | table | pierre   | 15 MB      | Grade-control samples during mining exploitation{{{                                                                                 Table "public.grade_ctrl"
       Column        |            Type             |                            Modifiers                             | Storage  |                       Description                        
---------------------+-----------------------------+------------------------------------------------------------------+----------+----------------------------------------------------------
 id                  | character varying(4)        |                                                                  | extended | Quarry and block identification in 4 characters
 num                 | character varying(10)       |                                                                  | extended | sample number
 x                   | numeric(10,2)               |                                                                  | main     | X drill hole collar coordinate, projected in UTM (m)
 y                   | numeric(10,2)               |                                                                  | main     | Y drill hole collar coordinate, projected in UTM (m)
 z                   | numeric(10,2)               |                                                                  | main     | Z drill hole collar coordinate, projected in UTM (m)
 prof                | numeric(10,2)               |                                                                  | main     | End of sample depth
 aucy                | numeric(10,2)               |                                                                  | main     | Sample cyanidable gold grade (g/t)
 autot               | numeric(10,2)               |                                                                  | main     | Total gold grade (g/t)
 litho               | character varying(20)       |                                                                  | extended | Sample lithology in GDM or Sermine code
 old_id              | character varying(20)       |                                                                  | extended | Quarry and block old identification 
 numauto             | integer                     | not null default nextval('preex_sampling_numauto_seq'::regclass) | plain    | Automatic integer primary key
 aucy2               | numeric(10,2)               |                                                                  | main     | 
 datasource          | integer                     |                                                                  | plain    | Datasource identifier, refers to lex_datasource
 opid                | integer                     |                                                                  | plain    | Operation identifier
 db_update_timestamp | timestamp without time zone | default now()                                                    | plain    | Current date and time stamp when data is loaded in table
 username            | character varying           | default "current_user"()                                         | extended | User (role) which created data record
Indexes:
    "preex_sampling_pkey" PRIMARY KEY, btree (numauto)
    "id_preex_sampling" btree (id)
    "xyz_preex_sampling" btree (x, y, z)
Has OIDs: no
}}}
 public | index_geo_documentation            | table | pierre   | 16 kB      | {{{                                                                               Table "public.index_geo_documentation"
       Column        |            Type             |                                 Modifiers                                 | Storage  |                       Description                        
---------------------+-----------------------------+---------------------------------------------------------------------------+----------+----------------------------------------------------------
 id                  | integer                     | not null default nextval('index_geo_documentation_id_seq'::regclass)      | plain    | 
 title               | character varying(100)      |                                                                           | extended | 
 lat_min             | numeric(20,8)               |                                                                           | main     | 
 lat_max             | numeric(20,8)               |                                                                           | main     | 
 lon_min             | numeric(20,8)               |                                                                           | main     | 
 lon_max             | numeric(20,8)               |                                                                           | main     | 
 opid                | integer                     |                                                                           | plain    | Operation identifier
 db_update_timestamp | timestamp without time zone | default now()                                                             | plain    | Current date and time stamp when data is loaded in table
 username            | character varying           | default "current_user"()                                                  | extended | User (role) which created data record
 numauto             | integer                     | not null default nextval('index_geo_documentation_numauto_seq'::regclass) | plain    | Automatic integer primary key
 datasource          | integer                     |                                                                           | plain    | Datasource identifier, refers to lex_datasource
Indexes:
    "index_geo_documentation_pkey" PRIMARY KEY, btree (numauto)
Has OIDs: no
}}}
 public | operation_active                   | table | pierre   | 40 kB      | {{{                                                                               Table "public.operation_active"
       Column        |            Type             |                             Modifiers                              | Storage  |                       Description                        
---------------------+-----------------------------+--------------------------------------------------------------------+----------+----------------------------------------------------------
 opid                | integer                     |                                                                    | plain    | Operation identifier
 db_update_timestamp | timestamp without time zone | default now()                                                      | plain    | Current date and time stamp when data is loaded in table
 username            | character varying           | default "current_user"()                                           | extended | User (role) which created data record
 numauto             | integer                     | not null default nextval('operation_active_numauto_seq'::regclass) | plain    | Automatic integer
Has OIDs: no
}}}

 public | spatial_ref_sys                    | table | postgres | 2952 kB    | 
 public | geometry_columns                   | table | postgres | 8192 bytes | {{{                         Table "public.geometry_columns"
      Column       |          Type          | Modifiers | Storage  | Description 
-------------------+------------------------+-----------+----------+-------------
 f_table_catalog   | character varying(256) | not null  | extended | 
 f_table_schema    | character varying(256) | not null  | extended | 
 f_table_name      | character varying(256) | not null  | extended | 
 f_geometry_column | character varying(256) | not null  | extended | 
 coord_dimension   | integer                | not null  | plain    | 
 srid              | integer                | not null  | plain    | 
 type              | character varying(30)  | not null  | extended | 
Indexes:
...
(46 rows)
 ...
 public | locations                          | table | pierre   | 8192 bytes | Zones, prospects code, rectangle {{{
                                                                               Table "public.locations"
       Column        |            Type             |                          Modifiers                          | Storage  |                       Description                        
---------------------+-----------------------------+-------------------------------------------------------------+----------+----------------------------------------------------------
 operation           | character varying(4)        | not null default 'HASS'::character varying                  | extended | Operation id
 location            | character varying(20)       | not null                                                    | extended | Location code name, see collars.location
 full_name           | character varying(100)      |                                                             | extended | Location full name
 lat_min             | numeric(10,5)               | not null                                                    | main     | South latitude, decimal degrees, WGS84
 lon_min             | numeric(10,5)               | not null                                                    | main     | West longitude, decimal degrees, WGS84
 lat_max             | numeric(10,5)               |                                                             | main     | North latitude, decimal degrees, WGS84
 lon_max             | numeric(10,5)               |                                                             | main     | East latitude, decimal degrees, WGS84
 ...
 db_update_timestamp | timestamp without time zone | default now()                                               | plain    | Current date and time stamp when data is loaded in table
 username            | character varying           | default "current_user"()                                    | extended | User (role) which created data record
 numauto             | integer                     | not null default nextval('locations_numauto_seq'::regclass) | plain    | Automatic integer primary key
 datasource          | integer                     |                                                             | plain    | Datasource identifier, refers to lex_datasource
Indexes:
    "locations_pkey" PRIMARY KEY, btree (numauto)
Has OIDs: no
}}}
=> vide! Je la vire dans zz_poubelle:
ALTER TABLE public.locations SET SCHEMA zz_poubelle;

Voilà cet ordre des tables, pour la génération de documentation:
order_tables_for_documentation: [ ; {{{ } } }
operations
