...
;/*}}}*/
; Include Christopher Ross-Gill's altjson. Inclusion de l'utilitaire altjson de Christopher Ross-Gill:;{{{ } } }
;write %/tmp/altjson read http://reb4.me/r/altjson
;:r /tmp/altjson
Rebol [
...
;}}}
; Include Sunanda's base-convert. Inclusion de l'utilitaire base-convert de Sunanda:;{{{ } } }
;:r ~/dev/rebol/library/scripts/base-convert.r
;{{{
REBOL [
   file: %base-convert.r
...
; Build easily accessible functions to convert back and forth between common bases:
bases: [bin 2 octal 8 decimal 10 hex 16 gers 32]               ; bases: binary 2, octal 8, decimal 10, hexadecimal 16, gers 32
foreach [dep basedep] bases [                                  ; dep: departure base
	foreach [arr basearr] bases [                              ; arrival base
		unless dep = arr [
